...
export default function PermanentEventDelete({ eventId, eventName, canManage }: Props) {
  ...
  return (
    <>
      <button type="button" className="rounded-lg border border-red-200 px-3 py-2 text-sm font-medium text-red-600 transition hover:bg-red-50 dark:border-red-900/60 dark:hover:bg-red-950/40" onClick={openModal}>
